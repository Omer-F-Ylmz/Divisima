...
0b. **LAUNCH-FIX FAZI SURUYOR.** Bes dalga planlandi: A ilk musteri zinciri, B operasyon
   ...
   **SIRADAKI: DALGA D'NIN KALAN KALEMLERI** - D1 uygulama, D3 (gercek olcek provasi),
   D5 (Redis acik kosum), D6 (yedek/geri donus tatbikati). Artik GERCEK ZEMINDE kosacaklar.
