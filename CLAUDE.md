...
0b. **LAUNCH-FIX FAZI SURUYOR.** Bes dalga planlandi: A ilk musteri zinciri, B operasyon
   ...
   **DALGA B TAMAMLANDI** (bu bolum yazilirken push BEKLIYOR) - admin panelinin HIC ACILMAMIS
   bes ekrani surulup B1..B5 kapatildi; ayrintisi "DALGA B - OPERASYON YUZEYI" bolumunde.
   **SIRADAKI: DALGA C (yayin altyapisi)** - kapsami KULLANICIDAN gelecek, HENUZ IS ACILMADI.
