...
namespace Divisima.DataAccess.Concrete.EntityFramework { public class EfSizeGuideEntryDal : EfEntityRepositoryBase<SizeGuideEntry, DivisimaDbContext>, ISizeGuideEntryDal
    {
