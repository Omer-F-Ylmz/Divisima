...
namespace Divisima.DataAccess.Concrete.EntityFramework { public class EfReviewHelpfulVoteDal : EfEntityRepositoryBase<ReviewHelpfulVote, DivisimaDbContext>, IReviewHelpfulVoteDal
    {
