...
namespace Divisima.DataAccess.Concrete.EntityFramework { public class EfProductAttributeDal : EfEntityRepositoryBase<ProductAttribute, DivisimaDbContext>, IProductAttributeDal
    {
